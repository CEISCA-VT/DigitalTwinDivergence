...
class InteractiveMotionController:
    ...
    def _prompt_next_step(self) -> InteractiveStep | None:
        ...
        choice = input("Motion [f/r/c/a/s/q]: ").strip().lower()
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--forward-cmd", type=float, default=0.14)
    parser.add_argument("--reverse-cmd", type=float, default=0.14)
    parser.add_argument("--turn-cmd", type=float, default=0.045)
    parser.add_argument(
        "--turn-control",
        choices=("encoder", "yaw"),
        default="encoder",
...
def main() -> None:
    ...
    controller = InteractiveMotionController(
        ...
        reverse_cmd=args.reverse_cmd,
        turn_cmd=args.turn_cmd,
