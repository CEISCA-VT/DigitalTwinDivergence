...
def load_refined_checkpoint(
    ...
    *,
    ...
    """Load a locally-created refined checkpoint without retraining."""
    ...
    model = RefinedDualGRU(
        ...
        alpha_min=float(checkpoint["alpha_min"]),
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Final i2Nav model study v2: repaired OEM719 selection + official NED/FRD export + checkpoint re-evaluation."
    )
    ...
    p.add_argument(
        ...
        default=None,
        help=(
            "Directory containing existing fold_XX_<sequence>/refined_dual_best.pt "
...
def main() -> int:
    ...
    for outer_i, fold in enumerate(folds, start=1):
        ...
        try:
            ...
            if args.eval_existing:
                ...
                checkpoint_path = source_fold_dir / "refined_dual_best.pt"
    ...
    final_summary = {
        "schema": "i2nav_final_model_study_v2_repaired",
        "device": str(device),
